        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFlat = table.Column<bool>(type: "boolean", nullable: false),
                    IsBusinessWide = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceTime", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceTime_Product_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ServiceTimeId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservation_ServiceTime_ServiceTimeId",
                        column: x => x.ServiceTimeId,
                        principalTable: "ServiceTime",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservation_ServiceTimeId",
                table: "Reservation",
                column: "ServiceTimeId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceTime_ServiceId",
                table: "ServiceTime",
                column: "ServiceId");
